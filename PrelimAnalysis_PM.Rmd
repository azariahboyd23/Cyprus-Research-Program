...
pm10 <- df %>% filter(df$`PM (PM2.5,PM10)` == "PM10")    
pm2.5 <- df %>% filter(df$`PM (PM2.5,PM10)` == "PM2.5")

model3 <- lm(log(pm10$`PM MASS (μg/m3)`) ~ log(pm10$Average))
summary(model3)

model4 <- lm(log(pm2.5$`PM MASS (μg/m3)`) ~ log(pm2.5$Average))
summary(model4)

model5 <- glm(`PM MASS (μg/m3)` ~   ) 
